  ...
  <Wrap justify="space-evenly"  >
{
    ...
    return (
        ...
        <Box maxW='md' ml="120px" width="250px" borderWidth='1px' borderRadius='lg' key={x.id} overflow='hidden' mt ="100px">
          <Image src={x.picture} />
        ...
        <ChakraLink as={Link} to={`/details/${x.id}`}>
             ...
             <Box>
                <Button colorScheme='red' height= "25px" mt="10px" onClick={() => deleteApartment(x.id)}>Delete</Button>
            </Box>
        </Box>
